...
import 'package:onboarding_screen/component/rounded_button.dart';
  ...
  Widget createProgressDots(bool isActiveScreen) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: isActiveScreen ? Colors.blue : Colors.grey, borderRadius: const BorderRadius.all(Radius.circular(12))),
    );
  }
